<?php
    $admin_name = "Jane Admin"; $profile_image_url = "https://placehold.co/150x150/d1d5db/000000?text=JD"; $active_link = 'Reports';
...
<div class="flex-1 content-area p-4 md:p-6 w-full bg-gray-50 max-w-7xl">
    ...
    <!-- Page Header -->
    <div class="mb-4">
        <h1 class="text-3xl font-bold text-gray-800">Emergency Reports</h1>
        <p class="text-gray-600 mt-1">View and manage user-submitted emergency reports</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
            ...
            <h3 class="text-3xl font-bold text-gray-800">245</h3>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
            <p class="text-sm text-gray-600 mb-1">Pending Review</p>
            <h3 class="text-3xl font-bold text-orange-600">12</h3>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
            <p class="text-sm text-gray-600 mb-1">Under Investigation</p>
            <h3 class="text-3xl font-bold text-red-700">8</h3>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
            <p class="text-sm text-gray-600 mb-1">Resolved</p>
            <h3 class="text-3xl font-bold text-green-600">225</h3>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 space-y-4 md:space-y-0">
            <h2 class="text-xl font-bold text-gray-800">All Emergency Reports</h2>
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-200">
                        <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">Report ID</th>
                        <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">Type</th>
                        <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">Reported By</th>
                ...
                <tbody class="text-sm">
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4 text-gray-800 font-medium">#RPT-001</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <i class="fa-solid fa-water text-red-700"></i>
                                <span class="text-gray-800">Flood</span>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <img src="https://placehold.co/32x32/d1d5db/000000?text=JD" alt="User" class="h-6 w-6 rounded-full">
                        ...
                        <td class="py-3 px-4">
                            <span class="bg-orange-100 text-orange-700 px-2 py-1 rounded text-xs font-medium">Pending</span>
                        </td>
                        <td class="py-3 px-4 text-gray-600">Nov 24, 2025 10:15 AM</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <button class="text-gray-600 hover:text-red-700 p-1" title="View Details">
                                    <i class="fa-solid fa-eye"></i>
                                </button>
                                <button class="text-gray-600 hover:text-red-700 p-1" title="Update Status">
                    ...
                    <!-- Report Row 2 -->
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4 text-gray-800 font-medium">#RPT-002</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <i class="fa-solid fa-fire text-red-700"></i>
                                <span class="text-gray-800">Fire</span>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <img src="https://placehold.co/32x32/d1d5db/000000?text=MS" alt="User" class="h-6 w-6 rounded-full">
                                <span class="text-gray-800">Maria Santos</span>
                            </div>
                        </td>
                        ...
                        <td class="py-3 px-4">
                            <span class="bg-yellow-100 text-yellow-700 px-2 py-1 rounded text-xs font-medium">Investigating</span>
                        </td>
                        <td class="py-3 px-4 text-gray-600">Nov 23, 2025 3:30 PM</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <button class="text-gray-600 hover:text-red-700 p-1" title="View Details">
                                    <i class="fa-solid fa-eye"></i>
                    ...
                    <!-- Report Row 3 -->
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4 text-gray-800 font-medium">#RPT-003</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <i class="fa-solid fa-house-crack text-red-700"></i>
                                <span class="text-gray-800">Earthquake</span>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <img src="https://placehold.co/32x32/d1d5db/000000?text=PR" alt="User" class="h-6 w-6 rounded-full">
                                <span class="text-gray-800">Pedro Reyes</span>
                            </div>
                        </td>
                        ...
                        <td class="py-3 px-4">
                            <span class="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-medium">Resolved</span>
                        </td>
                        <td class="py-3 px-4 text-gray-600">Nov 22, 2025 9:00 AM</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <button class="text-gray-600 hover:text-red-700 p-1" title="View Details">
                                    <i class="fa-solid fa-eye"></i>
                    ...
                    <!-- Report Row 4 -->
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4 text-gray-800 font-medium">#RPT-004</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <i class="fa-solid fa-car-burst text-red-700"></i>
                                <span class="text-gray-800">Accident</span>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <img src="https://placehold.co/32x32/d1d5db/000000?text=AG" alt="User" class="h-6 w-6 rounded-full">
                                <span class="text-gray-800">Ana Garcia</span>
                            </div>
                        </td>
                        ...
                        <td class="py-3 px-4 text-gray-600">Nov 21, 2025 6:45 PM</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <button class="text-gray-600 hover:text-red-700 p-1" title="View Details">
                                    <i class="fa-solid fa-eye"></i>
                    ...
                    <!-- Report Row 5 -->
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4 text-gray-800 font-medium">#RPT-005</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <i class="fa-solid fa-mountain text-red-700"></i>
                                <span class="text-gray-800">Landslide</span>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <img src="https://placehold.co/32x32/d1d5db/000000?text=RB" alt="User" class="h-6 w-6 rounded-full">
                                <span class="text-gray-800">Roberto Bautista</span>
                            </div>
                        </td>
                        ...
                        <td class="py-3 px-4 text-gray-600">Nov 20, 2025 11:20 AM</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <button class="text-gray-600 hover:text-red-700 p-1" title="View Details">
                                    <i class="fa-solid fa-eye"></i>
                    ...
                    <!-- Report Row 6 -->
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4 text-gray-800 font-medium">#RPT-006</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <i class="fa-solid fa-water text-red-700"></i>
                                <span class="text-gray-800">Flood</span>
                        ...
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <img src="https://placehold.co/32x32/d1d5db/000000?text=LC" alt="User" class="h-6 w-6 rounded-full">
                                <span class="text-gray-800">Lisa Cruz</span>
                            </div>
                        </td>
                        <td class="py-3 px-4 text-gray-600">Pasig City</td>
                        <td class="py-3 px-4">
                            <span class="bg-yellow-100 text-yellow-700 px-2 py-1 rounded text-xs font-medium">Moderate</span>
                        </td>
                        <td class="py-3 px-4">
                        ...
                        <td class="py-3 px-4 text-gray-600">Nov 19, 2025 2:30 PM</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <button class="text-gray-600 hover:text-red-700 p-1" title="View Details">
                                    <i class="fa-solid fa-eye"></i>
        ...
        <div class="flex items-center justify-between mt-6 pt-4 border-t border-gray-200">
            <p class="text-sm text-gray-600">Showing 1 to 6 of 245 reports</p>
            <div class="flex items-center space-x-2">
