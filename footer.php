    ...
    <footer class="bg-[#101010] text-gray-300 border-t border-red-700/50 pt-12 pb-8 shadow-2xl">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="#" class="text-red-500 hover:text-white transition duration-200 text-2xl" aria-label="Twitter"><i class="fa-brands fa-twitter"></i></a>
            ...
            <div class="mt-12 border-t border-gray-700/50 pt-6 text-center text-xs">
                &copy; <?php echo date("Y"); ?> SafeMati. All rights reserved. Disaster Risk Reduction Management Office (DRRMO).
            </div>
        </div>
    </footer>
