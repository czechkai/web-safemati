<?php
    $admin_name = "Jane Admin"; $profile_image_url = "https://placehold.co/150x150/d1d5db/000000?text=JD"; $active_link = 'Guides Management';
...
<div class="flex-1 content-area p-4 md:p-6 w-full bg-gray-50 max-w-7xl">
    ...
    <!-- Page Header -->
    <div class="mb-4">
        <h1 class="text-3xl font-bold text-gray-800">Guides Management</h1>
        <p class="text-gray-600 mt-1">Manage disaster preparedness and safety guides</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
            ...
            <h3 class="text-3xl font-bold text-orange-600">4</h3>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
            <p class="text-sm text-gray-600 mb-1">Total Views</p>
            <h3 class="text-3xl font-bold text-red-700">12,458</h3>
        </div>
    </div>

    <!-- Add Guide Form -->
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100 mb-8">
        <h2 class="text-xl font-bold text-gray-800 mb-4">Add New Guide</h2>
        <form class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Guide Title</label>
                    <input type="text" placeholder="e.g., Earthquake Safety Guide" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-red-300 focus:border-red-400">
                </div>
                <div>
            ...
            <div>
                ...
                <textarea rows="2" placeholder="Brief overview of the guide..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-red-300 focus:border-red-400"></textarea>
            </div>
            
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Guide Content</label>
                <textarea rows="6" placeholder="Detailed guide content with instructions and safety tips..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-red-300 focus:border-red-400"></textarea>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Featured Image</label>
                    <input type="file" accept="image/*" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-red-300 focus:border-red-400">
                </div>
                <div>
            ...
            <div class="flex items-center space-x-4">
                <button type="submit" class="bg-red-700 hover:bg-red-800 text-white px-6 py-2 rounded-lg font-medium transition">
                    <i class="fa-solid fa-plus mr-2"></i> Add Guide
                </button>
    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-200">
                        <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">Guide Title</th>
                ...
                <tbody class="text-sm">
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-3">
                                <i class="fa-solid fa-house-crack text-red-700 text-lg"></i>
                                <div>
                                    <p class="text-gray-800 font-medium">Earthquake Safety Guide</p>
                                    <p class="text-xs text-gray-500">What to do before, during, and after an earthquake</p>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <span class="bg-red-100 text-red-700 px-2 py-1 rounded text-xs font-medium">Earthquake</span>
                        </td>
                        <td class="py-3 px-4 text-gray-600">2,456</td>
                        <td class="py-3 px-4">
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-3">
                                <i class="fa-solid fa-water text-red-700 text-lg"></i>
                                <div>
                                    <p class="text-gray-800 font-medium">Flood Preparedness</p>
                                    <p class="text-xs text-gray-500">How to prepare for and respond to flooding</p>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <span class="bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs font-medium">Flood</span>
                        </td>
                        <td class="py-3 px-4 text-gray-600">3,124</td>
                        <td class="py-3 px-4">
                            <span class="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-medium">Published</span>
                        </td>
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-3">
                                <i class="fa-solid fa-wind text-red-700 text-lg"></i>
                                <div>
                                    <p class="text-gray-800 font-medium">Typhoon Safety Tips</p>
                                    <p class="text-xs text-gray-500">Essential guidelines for typhoon season</p>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <span class="bg-purple-100 text-purple-700 px-2 py-1 rounded text-xs font-medium">Typhoon</span>
                        </td>
                        <td class="py-3 px-4 text-gray-600">1,892</td>
                        <td class="py-3 px-4">
                            <span class="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-medium">Published</span>
                        </td>
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-3">
                                <i class="fa-solid fa-fire text-red-700 text-lg"></i>
                                <div>
                                    <p class="text-gray-800 font-medium">Fire Prevention and Response</p>
                                    <p class="text-xs text-gray-500">Fire safety measures for homes and buildings</p>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <span class="bg-orange-100 text-orange-700 px-2 py-1 rounded text-xs font-medium">Fire</span>
                        </td>
                        <td class="py-3 px-4 text-gray-600">1,567</td>
                        <td class="py-3 px-4">
                            <span class="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-medium">Published</span>
                        </td>
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-3">
                                <i class="fa-solid fa-mountain text-red-700 text-lg"></i>
                                <div>
                                    <p class="text-gray-800 font-medium">Landslide Warning Signs</p>
                                    <p class="text-xs text-gray-500">Identifying and responding to landslide risks</p>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <span class="bg-yellow-100 text-yellow-700 px-2 py-1 rounded text-xs font-medium">Landslide</span>
                        </td>
                        <td class="py-3 px-4 text-gray-600">892</td>
                        <td class="py-3 px-4">
                            <span class="bg-orange-100 text-orange-700 px-2 py-1 rounded text-xs font-medium">Draft</span>
                        </td>
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-3">
                                <i class="fa-solid fa-kit-medical text-red-700 text-lg"></i>
                                <div>
                                    <p class="text-gray-800 font-medium">Emergency First Aid</p>
                                    <p class="text-xs text-gray-500">Basic first aid procedures for emergencies</p>
                                </div>
                            </div>
                        </td>
                        <td class="py-3 px-4">
                            <span class="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-medium">General Safety</span>
                        </td>
                        <td class="py-3 px-4 text-gray-600">1,234</td>
                        <td class="py-3 px-4">
                            <span class="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-medium">Published</span>
                        </td>
                        <td class="py-3 px-4 text-gray-600">Nov 14, 2025</td>
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <button class="text-gray-600 hover:text-red-700 p-1" title="View">
                                    <i class="fa-solid fa-eye"></i>
        ...
        <div class="flex items-center justify-between mt-6 pt-4 border-t border-gray-200">
            <p class="text-sm text-gray-600">Showing 1 to 6 of 28 guides</p>
            <div class="flex items-center space-x-2">
